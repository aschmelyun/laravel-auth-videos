  ...
  methods: {
    handleLogin: function handleLogin() {
      ...
      axios.get('/sanctum/csrf-cookie').then(function (response) {
        axios.post('/login', _this.login).then(function (response) {
          _this.getUser();
        });
      });
    },
    ...
    getToken: function getToken() {
      ...
      axios.post('/tokens/create', {
        ...
        _this4.token = response.data.token;
      });
    }
  }
});
      ...
      ? _c(
          ...
          [
            _c(
              ...
              {
                staticClass:
                  "text-gray-900 text-2xl mb-8 font-medium title-font"
              },
              [
                _vm._v("Welcome, "),
            ...
            _vm._l(_vm.entries, function(entry) {
              return _c("div", { attrs: { id: entry.id } }, [
                _c("h3", {
                  staticClass: "text-gray-900 mb-1 font-medium title-font",
                  domProps: { textContent: _vm._s(entry.title) }
                }),
                _vm._v(" "),
                _c("p", {
                  staticClass: "text-gray-500 mb-1 font-normal",
                  domProps: { textContent: _vm._s(entry.content) }
                })
              ])
            }),
            _vm._v(" "),
            _c("input", {
              ...
              staticClass:
                "w-full my-4 bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out",
            ...
            _c(
              ...
              {
                staticClass:
                  "text-white bg-indigo-500 border-0 py-2 px-6 mr-4 focus:outline-none hover:bg-indigo-600 rounded text-lg",
                on: { click: _vm.getEntries }
              },
              [_vm._v("Get My Entries")]
            ),
            _vm._v(" "),
            _c(
              "button",
