            ...
            @csrf
                ...
                <div>
                    ...
                    <input
                        ...
                        required
                        autofocus
                        class="block mt-1 mb-2 w-full py-2 px-3 rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                    >
                </div>
